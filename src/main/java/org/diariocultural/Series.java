...
public class Series extends Media {
     ...
     */
    public Series() {
        super("", new ArrayList<>(), 0); // Chamada ao construtor da superclasse com valores padrão
        this.seriesId = 0; // Valor temporário, será sobrescrito ou gerado
        this.seasons = new ArrayList<>();
        this.whereToWatch = new ArrayList<>();
     ...
     */
    public Series(String title, String originalTitle, List<String> genre,
                  int releaseYear, int endYear, List<String> whereToWatch,
                  List<String> cast, boolean watchedStatus) {
    ...
    // Setter para seasons, importante para Jackson popular a lista ao ler do JSON
    ...
    public void addSeason(Season season) {
        ...
        if (season != null) {
            // Opcional: Lógica para evitar adicionar temporadas com mesmo número
            // ou para substituir uma temporada existente.
